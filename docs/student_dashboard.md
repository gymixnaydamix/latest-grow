...
-   **Available Overlay Apps:** The Student has access to the full suite of overlay applications, as these are the core tools for their creative projects, research, and learning (e.g., **Studio** for creating presentations, **Media** for watching educational content). The internal navigation within these apps is identical to the Owner's view.
