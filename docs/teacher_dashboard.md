# Grow Your Need - Teacher Dashboard Wireframe & UI/UX Specification

This document provides a comprehensive wireframe and specification for the "Teacher" role view within the Dynamic SaaS Dashboard. It details the specific navigation, components, and features available to a teacher user within a school tenant.
...
The Teacher dashboard adheres to the core UI philosophy and style guide outlined in the main `grow-your-need-wire-frame.md` document, ensuring a consistent and high-quality user experience.
...
## 3. Component Wireframe: Teacher's View
...
-   **Functionality:** The footer provides toggles for the sidebars and access to the App Launcher, consistent with the main platform design.
-   **Available Overlay Apps:** Teachers have access to the full suite of overlay applications. This is crucial for creating educational content (e.g., using Studio to build presentations and documents, or Media to curate educational video playlists). The internal navigation within these apps is identical to the Owner's view.

---
## 4. Key Notifications for Teachers

To ensure teachers are always informed, the system should proactively send notifications for key events related to their classes and students. These notifications can be delivered via email, push notifications, or within the dashboard's notification center.

### 4.1. Types of Notifications

1. **Classroom Updates:** Notifications about changes to class schedules, room assignments, or important announcements.
2. **Student Performance Alerts:** Alerts for students who are falling behind, have missing assignments, or need additional support.
3. **Event Reminders:** Reminders for upcoming school events, parent-teacher conferences, and professional development opportunities.
4. **Administrative Notifications:** Updates from school administration regarding policy changes, deadlines, or required actions.

### 4.2. Customization Options

Teachers should have the ability to customize their notification preferences, including:
-   **Delivery Method:** Choose how they receive notifications (e.g., email, push, in-app).
-   **Frequency:** Set preferences for how often they receive updates (e.g., immediately, daily digest).
-   **Content Filters:** Select which types of notifications they want to receive based on their role and responsibilities.

### 4.3. Importance of Notifications

Timely and relevant notifications are crucial for helping teachers stay organized, prioritize their tasks, and respond effectively to student needs. By leveraging AI and data analytics, the system can ensure that teachers receive the most pertinent information without being overwhelmed by unnecessary alerts.
-   When a student has an unexcused absence or reaches a certain number of absences.
    -   Alerts for tardiness patterns (e.g., more than 3 tardies in a month).
-   **Financial Alerts:**
    -   When a tuition payment is due or overdue.
    -   Notification of a new bill being posted.
    -   Receipt of payment confirmation.
-   **School Announcements:**
    -   General announcements posted by the school administration.
    -   Notifications about school closures or emergency events.
-   **Student Alerts:**
    -   When a student logs a significantly negative mood in their Wellness Hub.
    -   Alerts for students with multiple missing or overdue assignments.
    -   Notifications about student behavior incidents reported by staff.
This ensures teachers can stay proactively engaged and support their students effectively without needing to constantly check the dashboard for updates.
