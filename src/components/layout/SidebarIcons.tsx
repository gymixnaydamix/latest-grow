...
import {
  IconProviderAI3D,
  IconProviderAnalytics3D,
  IconProviderApi3D,
  IconProviderAudit3D,
  IconProviderBackup3D,
  IconProviderBilling3D,
  IconProviderBranding3D,
  IconProviderComms3D,
  IconProviderDataOps3D,
  IconProviderHome3D,
  IconProviderIncidents3D,
  IconProviderIntegrations3D,
  IconProviderNotifications3D,
  IconProviderOnboarding3D,
  IconProviderReleases3D,
  IconProviderSecurity3D,
  IconProviderSettings3D,
  IconProviderSupport3D,
  IconProviderTeam3D,
  IconProviderTenants3D,
} from './provider-sidebar-3d-icons';
...
export const sidebarIconMap: Record<string, React.FC<IconProps>> = {
  ...
  provider_home: IconProviderHome3D,
  provider_tenants: IconProviderTenants3D,
  provider_onboarding: IconProviderOnboarding3D,
  provider_billing: IconProviderBilling3D,
  provider_support: IconProviderSupport3D,
  provider_incidents: IconProviderIncidents3D,
  provider_releases: IconProviderReleases3D,
  provider_integrations: IconProviderIntegrations3D,
  provider_security: IconProviderSecurity3D,
  provider_data_ops: IconProviderDataOps3D,
  provider_team: IconProviderTeam3D,
  provider_settings: IconProviderSettings3D,
  provider_audit: IconProviderAudit3D,
  provider_analytics: IconProviderAnalytics3D,
  provider_comms: IconProviderComms3D,
  provider_notifications: IconProviderNotifications3D,
  provider_branding: IconProviderBranding3D,
  provider_api_mgmt: IconProviderApi3D,
  provider_backup: IconProviderBackup3D,
  concierge_ai: IconProviderAI3D,
