...
import { childDisplayName, filterByChild, formatDateTimeLabel, parentAnnouncementsDemo } from './parent-v2-demo-data';
...
export function AnnouncementsSection({ scope, childId }: ParentSectionProps) {
  ...
  const allRows: ParentAnnouncementDemo[] = (rawRows as ParentAnnouncementDemo[] | undefined) ?? filterByChild(parentAnnouncementsDemo, childId, scope);
