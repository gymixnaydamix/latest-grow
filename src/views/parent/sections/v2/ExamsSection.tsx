...
import { childDisplayName, filterByChild, formatDateLabel, parentExamsDemo } from './parent-v2-demo-data';
...
export function ExamsSection({ scope, childId }: ParentSectionProps) {
  ...
  const allRows: ParentExamDemo[] = (rawData as ParentExamDemo[] | undefined) ?? filterByChild(parentExamsDemo, childId, scope);
