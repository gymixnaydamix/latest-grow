...
import { childDisplayName, filterByChild, parentTimetableDemo } from './parent-v2-demo-data';
...
export function TimetableSection({ scope, childId }: ParentSectionProps) {
  ...
  const allRows: ParentTimetableItemDemo[] = (rawData as ParentTimetableItemDemo[] | undefined) ?? filterByChild(parentTimetableDemo, childId, scope);
